...
final class NativeInt4SymmetricScorer extends NativeMemorySegmentScorer {

    NativeInt4SymmetricScorer(IndexInput in, int dimensions, int dataLength, int bulkSize) {
